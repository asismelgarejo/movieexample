...
const (
	...
	metadataServiceAddr = "localhost:8086"
...
func main() {
	...
	//#region Set up test clients for our services
	...
	//#regionend Set up test clients for our services
	...
	if got, want := getAggregatedRatingResp.Rating, float64(5); got != want {
	...
	if got, want := getAggregatedRatingResp.Rating, wantRating; got != want {
		log.Fatalf("rating mismatch: got %v want %v", got, want)
	}
