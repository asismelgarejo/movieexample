...
func (m *MockmetadataRepository) Get(ctx context.Context, id string) (*models.Metadata, error) {
        m.ctrl.T.Helper()
...
func (m *MockmetadataRepository) Put(ctx context.Context, id string, metadata *models.Metadata) error {
        m.ctrl.T.Helper()
